...
var iBox = function() {
	...
	var drawCSS = function() {
		...
		var default_skin = "#ibox_footer_wrapper {font-weight:bold;height:20px;line-height:20px;} #ibox_footer_wrapper a {text-decoration:none;background-color:#000;line-height:16px;padding:0 5px;color:#f7941d;font-weight:bold;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;} #ibox_footer_wrapper a:hover {background-color:#000;color:#fff;} #ibox_footer_wrapper {font-size:12px;font-family:Verdana, Arial, Helvetica, sans-serif;color:#fff; padding-left:10px; padding-top:5px; } #ibox_wrapper {border:1px solid #666;} #ibox_wrapper {background-color:#000;}#ibox_content {background-color:#000;} #ibox_loading {padding:50px; background-color:#000;color:#fff;font-size:16px;font-weight:bold;}";
